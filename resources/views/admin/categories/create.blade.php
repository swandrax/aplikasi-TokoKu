...
<div class="max-w-2xl bg-white border border-slate-100 rounded-3xl shadow-sm p-6 space-y-6">
    <div class="border-b border-slate-50 pb-4">
        <h3 class="font-extrabold text-slate-800 text-xs uppercase tracking-wider">Form Tambah Kategori</h3>
        <p class="text-[10px] text-slate-400 mt-1">Buat kategori produk baru dengan menginput detail formulir di bawah ini.</p>
    </div>
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-5">
        ...
        <div>
            ...
            <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Contoh: Elektronik Premium" required 
        ...
        <div class="flex items-center gap-2">
            ...
            <label for="is_active" class="text-xs font-bold text-slate-600 cursor-pointer">Aktifkan Kategori Langsung</label>
        </div>
