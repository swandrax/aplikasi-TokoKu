                ...
                <form action="{{ route('backend.user.update', $edit->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="role" class="form-control @error('role') is-invalid @enderror">
                                        ...
                                        <option value="0" {{ old('role', $edit->role) == '0' ? 'selected' : '' }}>User Admin</option>
                                        <option value="2" {{ old('role', $edit->role) == '2' ? 'selected' : '' }}>Customer</option>
                                    </select>
                    ...
                    <div class="border-top">
                        <div class="card-body">
                            ...
                            <a href="{{ ($isAdmin ?? false) ? route('backend.user.index') : route('backend.beranda') }}">
